var StackedMenu = function () {
    ...
    var t = function (t) {
        this.options = {
            compact: !1,
            hoverable: !1, closeOther: !0, align: 'right',
            selector: '#stacked-menu', selectorClass: 'stacked-menu'
            ...
            var s = this; e = e || this; for (var i = 0; i < s.length; i++)t.call(e, s[i], i, s)
            }),
            ...
            hoverable: this.options.selectorClass + '-has-hoverable', hasChild: 'has-child',
            hasActive: 'has-active', hasOpen: 'has-open'
            }, this.active = null, this.open = [],
            this.turbolinksAvailable = 'object' == typeof window.Turbolinks && window.Turbolinks.supported,
            this.handlerClickDoc = [], this.handlerOver = [],
            this.handlerOut = [], this.handlerClick = [], this.init()
